...
public class PagamentoAluno extends JFrame {
	...
	public PagamentoAluno() {
		...
		gbl_contentPane.columnWidths = new int[]{0, 0, 103, 125, 117, 90, 0};
		...
		JLabel lblNewLabel = new JLabel("Status do Pagamento:");
